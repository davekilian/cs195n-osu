...
void  aglDrawBitmapTranslated(GLint tex, GLfloat w, GLfloat h, GLfloat x, GLfloat y);
...
void Java_dkilian_andy_jni_agl_DrawBitmapTranslated(JNIEnv *env, jobject *thiz, jint tex, jfloat w, jfloat h, jfloat x, jfloat y);
